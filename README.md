...
**[Живое демо →](https://fedorov-n.ru/snag-demo/)** · [разбор проекта на сайте](https://fedorov-n.ru/projects/snag/)

Слева магазин, который ломается по кнопке, справа интерфейс Snag. Сервера у демо нет: тот же код приёма, группировки и API собран в WebAssembly и работает прямо во вкладке, а ошибки ловит настоящий SDK Sentry.
